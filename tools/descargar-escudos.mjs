...
const CONSULTAS = {
  'c-fc-barcelona': ['Barcelona', 'FC Barcelona'],
  ...
  'c-friburgo': 'Freiburg', 'c-colonia': 'FC Koln', 'c-hamburgo': ['Hamburger SV', 'Hamburg', 'HSV'],
  'c-maguncia-05': 'Mainz 05', 'c-augsburgo': 'Augsburg', 'c-union-berlin': 'Union Berlin',
  'c-paris-saint-germain': ['Paris SG', 'Paris Saint-Germain', 'PSG'], 'c-marsella': 'Marseille',
  'c-monaco': 'Monaco', 'c-niza': 'Nice', 'c-saint-etienne': ['AS Saint-Etienne', 'Saint-Etienne'],
  'c-sporting-de-lisboa': 'Sporting CP', 'c-vitoria-de-guimaraes': 'Vitoria Guimaraes',
  'c-club-brujas': 'Club Brugge', 'c-gante': 'Gent',
  'c-lille': ['Lille OSC', 'LOSC Lille', 'Lille'],
  'c-nottingham-forest': ['Nottingham Forest', 'Nottm Forest'],
  ...
  'c-dinamo-moscu': ['Dynamo Moscow', 'Dinamo Moscow', 'FC Dynamo Moscow'], 'c-legia-varsovia': 'Legia Warsaw',
  'c-lech-poznan': 'Lech Poznan', 'c-red-bull-salzburgo': 'Red Bull Salzburg',
  'c-rapid-viena': 'Rapid Vienna', 'c-slavia-praga': 'Slavia Prague',
  'c-sparta-praga': 'Sparta Prague', 'c-malmo-ff': 'Malmo FF', 'c-bodo-glimt': ['Bodo/Glimt', 'Bodo Glimt', 'FK Bodo/Glimt'],
  ...
  'c-al-duhail': ['Al-Duhail SC', 'Lekhwiya', 'Al Duhail'],
...
const LIGAS = {
  ...
  't-sudamericana': ['CONMEBOL Copa Sudamericana', 'Copa Sudamericana', 'Sudamericana'],
  't-confederaciones': ['FIFA Confederations Cup', 'Confederations Cup'],
  't-copa-america': ['CONMEBOL Copa America', 'Copa America', 'Copa América'],
  't-eurocopa': ['UEFA European Championships', 'UEFA Euro', 'European Championship', 'Euro'],
  't-copa-africana': ['Africa Cup of Nations', 'CAF Africa Cup of Nations', 'Africa Cup'],
  't-copa-asiatica': ['AFC Asian Cup', 'Asian Cup'],
  't-copa-oro': ['CONCACAF Gold Cup', 'Gold Cup'],
  't-mundial-clubes': ['FIFA Club World Cup', 'Club World Cup'],
  't-premier': ['English Premier League'],
  't-laliga': ['Spanish La Liga', 'LaLiga', 'La Liga'],
  't-serie-a': ['Italian Serie A'],
  't-bundesliga': ['German Bundesliga'],
  't-liga-chilena': ['Chilean Primera Division', 'Chilean Primera'],
